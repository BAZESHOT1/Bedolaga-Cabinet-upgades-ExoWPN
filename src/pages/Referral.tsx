...
export default function Referral() {
  ...
  return (
    <div className="space-y-6">
      {/* Header with title and Retail button */}
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-dark-50 sm:text-3xl">{t('referral.title')}</h1>
        {/* Кнопка "Розница" - показываем только если партнёр approved и есть 2+ кампании */}
        {isPartner && hasCampaigns && (
          <button
            onClick={() => navigate('/referral/retail')}
      ...
      {terms?.partner_section_visible !== false && showApprovedSection && (
        <div className="bento-card border-success-500/20">
          <div className="flex flex-wrap items-center gap-4">
            ...
            {/* Убираем кнопку "Розница" отсюда, она теперь наверху */}
...
export const RewardSettings = (_props: any) => null;
export const ProgrammeTerms = (_props: any) => null;
export const tierProgressText = (_props: any, _t?: any) => null;
